...
/* [Inside dimensions] */
inside_x = 63;   // interior width
depth_a  = 15;   // interior depth of first compartment
depth_b  = 50;   // interior depth of second compartment
inside_z = 88;   // interior height (floor to underside of lid top)
