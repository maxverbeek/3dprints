// Mercedes Sprinter paperwork clip — reverse-engineered from
// Mercedes_paperwork_Clip.stl (thing:4555576).
...
module back_features() {
    ...
    barrel(bar1_y[0], bar1_y[1]);
    translate([0, 2*mir_y, 0]) mirror([0,1,0]) barrel(bar1_y[0], bar1_y[1]);
}

module clip() { plate(); back_features(); }
